...
const confirm = async () => {
  ...
  // 提示消息
  FnMessage({ type: 'success', text: '下单成功~' })
  // 关闭弹窗
...
const changeAddress = async () => {
  ...
  if (selectAddress.value) {
    ...
    FnMessage({ type: 'success', text: '修改地址成功' })
    visible.value = false
  }
}
</script>
<template>
  <div class="checkout-address">
    ...
    <div class="action">
      ...
      <Button class="btn" @click="dialogVisible = true">添加地址</Button>
    </div>
    ...
    <Dialog title="切换收货地址" v-model:visible="visible">
      <template #default>
        <div
          class="text item"
      ...
      <template #footer>
        ...
        <Button type="primary" @click="changeAddress">确认</Button>
      </template>
    </Dialog>
  </div>
</template>
